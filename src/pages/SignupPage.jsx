    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="mx-auto max-w-[320px] text-center text-[13px] leading-[1.5] text-[#555555]">
            By continuing, you're agreeing to our{" "}
            <a target="_blank" href="/main-services-agreement" rel="noopener noreferrer" className="text-[#1d1c1d] no-underline">
              Main Services Agreement
            </a>,{" "}
            <a target="_blank" href="/terms-of-service/user" rel="noopener noreferrer" className="text-[#1d1c1d] no-underline">
              User Terms of Service
            </a>,{" "}
            and{" "}
            <a target="_blank" href="/slack-supplemental-terms" rel="noopener noreferrer" className="text-[#1d1c1d] no-underline">
              Slack Supplemental Terms
            </a>.{" "}
            Additional disclosures are available in our{" "}
            <a target="_blank" href="/privacy-policy" rel="noopener noreferrer" className="text-[#1d1c1d] no-underline">
              Privacy Policy
            </a>{" "}
            and{" "}
            <a target="_blank" href="/cookie-policy" rel="noopener noreferrer" className="text-[#1d1c1d] no-underline">
              Cookie Policy
            </a>.
          </div>
